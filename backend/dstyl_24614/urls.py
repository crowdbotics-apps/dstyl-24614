...
admin.site.site_header = "Dstyl"
admin.site.site_title = "Dstyl Admin Portal"
admin.site.index_title = "Dstyl Admin"

# swagger
api_info = openapi.Info(
    title="Dstyl API",
    default_version="v1",
    description="API documentation for Dstyl App",
)
